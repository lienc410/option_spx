...
最后更新：2026-05-10（SPEC-094.1: Sleeve A 参数更新 DTE 30 / +2.5%）
...
1. **检查 Telegram alert** 是否完整：
   ...
   - 推荐结构（Sleeve A: ATM/+2.5% call spread, DTE 30；Sleeve B: ATM/+5%, DTE 90；expiry date）
...
3. 短腿：**Sleeve A** +2.5% OTM（`signal_close * 1.025`）；**Sleeve B** +5% OTM（`signal_close * 1.05`）
4. 到期：alert 中 `expiry_date`（**Sleeve A**: DTE 30 calendar days；**Sleeve B**: DTE 90 calendar days）
   ⚠️ SPEC-094.1 生效日：2026-06-11（当前 2026-03-12 仓位按原 90-DTE 持至 2026-06-10 到期）
...
## 持仓期（Sleeve A: DTE 1-30；Sleeve B: DTE 1-90）
...
## 到期日（DTE 0；Sleeve A 每约 30 日轮转，Sleeve B 约 90 日）
