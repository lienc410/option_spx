...
- 结论：
  - `SPEC-071 sim / I1861 vs engine / D115`
  - 约 `16x` over-predict
...
- 内容：`SPEC-066` shipping 后，`Q018 R8 retrospective` 表明 `EXTREME_VOL` hard stop 已缓解 2008 tail 假设
- 结论：
...
- 日期：2026-04-24
- 结论：
  - resolved in production via `SPEC-066 + Q022 + SPEC-068`
