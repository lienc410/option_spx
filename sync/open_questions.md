...
最后更新：2026-04-26（Planner，同步顶层 objective reset，新增 `Q036` idle-BP capital-allocation 主线）
...
- **当前归类**：research — Phase 4 done，**ready to close pending PM final approval**（建议关闭，保留 V_A SPEC-066，不开 SPEC-067）
...
- **状态**：open（PM 最终产品化决策待定；Quant 当前 recommendation = hold，非 productize）
