...
**版本**: v1.2-draft — 待 PM ratify（v1.1 RATIFIED 2026-07-05）。修订走 PM ratify（§7）。
...
*v1.2-draft 2026-07-12 并入 Q089/Q090/工程周十课：按腿摩擦、MDE 分级 null、选择算术、states-vs-levels、outcome-conditioning 禁令、字段单位验证、派生面语义过滤、探针校准、语义自洽验收、多会话仓纪律 + 测试密闭性宪法化引用（待 PM ratify）*
